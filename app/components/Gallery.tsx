...
export default function Gallery({
  ...
  // Check if we should show background (when not using bg-transparent)
    ...
    <section className={clsx(
              ...
              <div className="relative overflow-hidden aspect-square">
                ...
                {image.title && (
                  <div className="absolute bottom-3 left-3 right-3">
                    <div className="bg-white/90 backdrop-blur-sm rounded-lg px-3 py-2 opacity-0 group-hover:opacity-100 transform translate-y-2 group-hover:translate-y-0 transition-all duration-300">
                      <p className="text-sm font-medium text-[#706152] truncate">{image.title}</p>
                    </div>
                  </div>
                )}
              </div>
      ...
      {selectedImage !== null && (
        ...
        >
          ...
          {/* Image counter */}
          <div className="absolute bottom-4 left-1/2 -translate-x-1/2 z-60 bg-white/10 backdrop-blur-sm rounded-full px-4 py-2">
          ...
          {images[selectedImage].title && (
            <div className="absolute bottom-16 left-1/2 -translate-x-1/2 z-60 bg-white/10 backdrop-blur-sm rounded-lg px-4 py-2 max-w-md">
              <p className="text-white text-sm text-center">{images[selectedImage].title}</p>
            </div>
          )}
        </div>
      )}
